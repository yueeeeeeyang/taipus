...
-- MySQL 脚本与 PostgreSQL 脚本必须保持相同版本号，方便审计跨数据库兼容状态。
CREATE TABLE app_metadata (
    ...
    PRIMARY KEY (id),
    UNIQUE KEY uk_app_metadata_key_deleted (metadata_key, deleted),
    KEY idx_app_metadata_deleted_updated_time (deleted, updated_time)
);
